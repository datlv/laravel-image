 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\Datlv\Image\Image[] $contentImages
 * @property-read \Illuminate\Database\Eloquent\Collection|\Datlv\Image\Image[] $linkedImages
 */
abstract class ImageableModel extends Model
{
    ...
    {
        $query = $this->morphToMany('Datlv\Image\Image', 'imageable', 'imageables', 'imageable_id', 'image_id');
